...
import { registerDreamCommand, registerIndexCommand } from "./memory-advanced.ts";
...
export function registerMemoryCommand(program: Command): void {
  ...
  // -- dream ----------------------------------------------------------------
  registerDreamCommand(cmd, initMemorySystem);

  // -- index ----------------------------------------------------------------
  registerIndexCommand(cmd, initMemorySystem);
}
