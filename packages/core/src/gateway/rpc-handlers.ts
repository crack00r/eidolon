 ...
 * Checks GPU worker availability, creates a tracked voice session,
 * and returns session configuration for the client.
 */
 ...
 * Stops and cleans up a tracked voice session.
 */
